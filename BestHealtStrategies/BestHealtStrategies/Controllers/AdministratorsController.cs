...
namespace BestHealtStrategies.Controllers
{
    public class AdministratorsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Email,Password,Name,Surname")] Administrator administrator)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Email,Password,Name,Surname")] Administrator administrator)
        {
